...
{
    public class RBHeldItem : ICloneable
    {
        ...
        public static RBHeldItem FromStoredItemParts(int itemID, int parameter)
        {
        ...
        {
            return Lists.RBItems.ContainsKey(ID) ? Lists.RBItems[ID] : string.Format(Language.UnknownItem, ID);
        }
